RSpec.describe Line::Social::Request::Base do
  describe '#http_client' do
    ...
    it 'raises Line::Social::BadRequestError' do
      ...
      expect {
        Line::Social::Request::Base.new.http_client(:post)
      }.to raise_error(Line::Social::BadRequestError)
    end
    ...
    it 'raises Line::Social::UnauthorizedError' do
      ...
      expect {
        Line::Social::Request::Base.new.http_client(:post)
      }.to raise_error(Line::Social::UnauthorizedError)
    end
    ...
    it 'raises Line::Social::ForbiddenError' do
      ...
      expect {
        Line::Social::Request::Base.new.http_client(:post)
      }.to raise_error(Line::Social::ForbiddenError)
    end
    ...
    it 'raises Line::Social::TooManyRequestsError' do
      ...
      expect {
        Line::Social::Request::Base.new.http_client(:post)
      }.to raise_error(Line::Social::TooManyRequestsError)
    end
    ...
    it 'raises Line::Social::InternalServerError' do
      ...
      expect {
        Line::Social::Request::Base.new.http_client(:post)
      }.to raise_error(Line::Social::InternalServerError)
    end
  end
end
